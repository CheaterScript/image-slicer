...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.OutputPathGroup.addWidget(self.label_2)
        ...
        self.InputPathGroup.addWidget(self.label)
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(80, 280, 500, 40))
        self.pushButton_3.setMinimumSize(QtCore.QSize(500, 40))
        font = QtGui.QFont()
        font.setPointSize(12)
